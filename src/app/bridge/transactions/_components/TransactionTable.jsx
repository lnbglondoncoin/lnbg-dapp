    ...
    <div className="flex flex-col gap-3 w-full">
      ...
      <div className="w-full overflow-auto">
        <table class="table-auto w-full">
          <thead>
            <tr className="bg-ash">
              <th className="text-start font-semibold px-6 py-2 uppercase">
                Token
              </th>
              <th className="text-start font-semibold pr-6 py-2 uppercase">
                Amount
              </th>
              <th className="text-start font-semibold pr-6 py-2 uppercase">
                Account
          ...
          <tbody>
            {dummyTransactions.map((transaction, index) => (
              <tr className="border-b border-ash" key={index}>
                <td className="py-3 px-6">{transaction.token}</td>
                <td className="py-3 pr-6">{transaction.amount}</td>
                <td className="py-3 pr-6">{transaction.account}</td>
                <td className="py-3 pr-6">{transaction.status}</td>
                <td className="py-3 pr-6">{transaction.type}</td>
